...
public class Question {
    ...
    //string output of the problem. e.g. "4+9=_"
    ...
    public Question(int upperLimit){
        ...
        this.firstanumber = randomNumber.nextInt(upperLimit);
        this.secondNumber = randomNumber.nextInt(upperLimit);
        this.answer = this.firstanumber + this.secondNumber;
        this.questionPhrase = firstanumber + " + " + secondNumber + " = ";
    ...
    public int getFirstanumber() {
        return firstanumber;
    }
    public void setFirstanumber(int firstanumber) {
